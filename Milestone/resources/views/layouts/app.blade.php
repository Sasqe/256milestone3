...
<body>
            ...
            <div class="container">
              ...
              <!--                 ------------------------------Authentication Links---------------------------------------             -->
               ...
               <!--                 ------------------------------Customer Navbar---------------------------------------             -->
                             ...
                             @elseif (Session::has('userid') &&  Session::has('role') && Session::get('role') != 0) 
                            
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('yourprofile') }}">{{ __('Profile') }}</a>
                                </li>
                                </li>
                                  <li class="nav-item">
 ...
 <!--                 ------------------------------Logout---------------------------------------             -->
                                ...
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                   	@php echo Session::get('username'); @endphp <span class="caret"></span>
                                </a>
